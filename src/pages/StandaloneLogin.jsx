...
export default function StandaloneLogin() {
  ...
  const isNewPassSame = async (newPass) => {
    ...
    const res = await fetch(
      "https://s9v4t5i8ej.execute-api.ap-southeast-1.amazonaws.com/dev/check-password/",
      {
        method: "POST",
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://s9v4t5i8ej.execute-api.ap-southeast-1.amazonaws.com/dev/login/",
        {
  ...
  const checkEmail = async (email) => {
    const response = await fetch(
      "https://s9v4t5i8ej.execute-api.ap-southeast-1.amazonaws.com/dev/check-email/",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const res = await fetch(
        "https://s9v4t5i8ej.execute-api.ap-southeast-1.amazonaws.com/dev/reset-password/",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
                ...
                <>
                  ...
                  <form
                    ...
                    onSubmit={async (e) => {
                      ...
                      const isValidEmail = /^[^\s@]+@[^\s@]+\.(com)$/.test(
                      ...
                      const isValidKinetiqAcc = /^[\w.%+-]+@kinetiq\.ph$/.test(
                        resetData.kinetiq_email
                      );
                ...
                <div>
                  <div className="email-form">
                    <p className="login-pass-details">
                      ...
                      <strong>{resetData.valid_email}</strong>. Enter it below
