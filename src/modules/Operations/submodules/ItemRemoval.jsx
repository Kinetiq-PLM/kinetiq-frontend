...
const ItemRemoval = () => {
  const [activeTab, setActiveTab] = useState("All");
    ...
    const handleSentButton = async () => {
      ...
      try {
          const response = await fetch(`https://js6s4geoo2.execute-api.ap-southeast-1.amazonaws.com/dev/send-to-management/`, {
              method: "POST",
              headers: {
    ...
    const fetchData = async () => {
      try {
          ...
          const response = await fetch("https://js6s4geoo2.execute-api.ap-southeast-1.amazonaws.com/dev/item-removal/");
