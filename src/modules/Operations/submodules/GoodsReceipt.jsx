...
const GoodsReceipt = ({ onBack, onSuccess, selectedData, selectedButton, employee_id }) => {
  ...
  const fetchVendors = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/supplier/");
  ...
  useEffect(() => {
    const fetchNextDocumentIds = async () => {
      if (isCreateMode) {
        try {
          const response = await fetch('https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/goods-tracking/get-next-doc-ids/');
  ...
  const handleInputChange = async (e, index, field) => {
      ...
      if (index !== updatedItems.length - 1 && currentItem.item_name.trim() === '') {
        ...
        try {
          await fetch(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/document-item/${currentItem.content_id}/`, {
            method: 'PATCH',
            headers: {
  ...
  const reloadDocumentItems = async () => {
    try {
      const response = await fetch(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/goods-tracking/${selectedData.document_id}/`);
  ...
  useEffect(() => {
    fetch('https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/get-warehouseID/')
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch('https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/item/')
      .then(res => res.json())
      .then(data => {
  ...
  const handleCreateDocument = async () => {
    try {
      ...
      // Call the create API
      const response = await fetch('https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/goods-tracking/custom-create/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    try {
      ...
      if (isCreateMode) {
        ...
        for (let item of updatedDocumentItems){
          ...
          let itemResponse
          if (item.content_id){
            itemResponse = await fetch(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/document-item/${item.content_id}/`, {
              method: 'PUT',
              headers: {
                'Content-Type': 'application/json',
              },
            ...
            itemResponse = await fetch(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/document-item/`, {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
              },
        ...
        const goodsTrackingResponse = await fetch(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/goods-tracking/${selectedData.document_id}/`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const fetchPurchaseOrders = async () => {
    try {
      const response = await fetch("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/purchase_order/");
  ...
  const handlePOSelect = async (poId) => {
    ...
    try {
      ...
      const response = await fetch(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/operation/purchase_order/${poId}/`);
