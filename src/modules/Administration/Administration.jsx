...
import "./styles/Administration.css"; // Assuming you'll add these styles to a CSS file
  ...
  return (
    <div className="admin">
        <div className="admin custom-scroll">
          <div className="bg-white shadow-md rounded-lg overflow-y-auto overflow-x-hidden mt-10 admin-dashboard-container"
            style={{
              width: "calc(100% - 25px)",
              height: "700px",
              marginLeft: "10px",
          ...
          >
            ...
            <div className="p-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 ml-10 mr-10">
              {/* Exchange Rate Card */}
                <div onClick={() => handleClick("Currency")} className="cursor-pointer border border-gray-200 rounded-sm shadow-sm p-5 flex items-center gap-4 bg-white hover:bg-blue-100 transition duration-300">
              ...
              {/* User Management */}
              <div onClick={() => handleClick("User")} className="cursor-pointer border border-gray-200 rounded-sm shadow-sm p-5 flex items-center gap-4 bg-white hover:bg-blue-100 transition duration-300">
              ...
              {/* Warehouse */}
              <div onClick={() => handleClick("Warehouse")} className="cursor-pointer border border-gray-200 rounded-sm shadow-sm p-5 flex items-center gap-4 bg-white hover:bg-blue-100 transition duration-300">
                <div className="text-3xl p-3 rounded-full bg-green-100 text-green-600">
                  <HomeOutlined />
                </div>
                <div>
              ...
              {/* Policy */}
              <div onClick={() => handleClick("Policy")} className="cursor-pointer border border-gray-200 rounded-sm shadow-sm p-5 flex items-center gap-4 bg-white hover:bg-blue-100 transition duration-300">
              ...
              {/* Audit Logs */}
              <div onClick={() => handleClick("Audit Logs")} className="cursor-pointer border border-gray-200 rounded-sm shadow-sm p-5 flex items-center gap-4 bg-white hover:bg-blue-100 transition duration-300">
              ...
              <div onClick={() => handleClick("Business Partner Masterlist")} className="cursor-pointer border border-gray-200 rounded-sm shadow-sm p-5 flex items-center gap-4 bg-white hover:bg-blue-100 transition duration-300">
