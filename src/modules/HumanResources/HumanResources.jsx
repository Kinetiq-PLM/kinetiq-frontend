  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const employeesRes = await axios.get("http://127.0.0.1:8001/api/employees/");
        ...
        try {
          const attendanceRes = await axios.get("http://127.0.0.1:8001/api/attendance_tracking/attendance_tracking/");
        ...
        const leaveRequestsRes = await axios.get("http://127.0.0.1:8001/api/employee_leave_requests/leave_requests/");
        const allLeaveRequests = leaveRequestsRes.data;
        
        // 4. Fetch employee performance data
        const performanceRes = await axios.get("http://127.0.0.1:8001/api/employee_performance/employee_performance/");
        const allPerformanceData = performanceRes.data;
        
        // 5. Fetch departments data
        const departmentsRes = await axios.get("http://127.0.0.1:8001/api/departments/department/");
        const departments = departmentsRes.data;

        // Make sure to fetch department superiors
        const departmentSuperiorsRes = await axios.get("http://127.0.0.1:8001/api/department_superiors/department-superiors/");
        ...
        try {
          const candidatesResponse = await axios.get('http://127.0.0.1:8001/api/candidates/candidates/');
          const interviewsResponse = await axios.get('http://127.0.0.1:8001/api/interviews/');
        ...
        const payrollRes = await axios.get("http://127.0.0.1:8001/api/payroll/payrolls/");
        const payroll = payrollRes.data;
        
        // 9. Fetch training data
        // const trainingRes = await axios.get("http://127.0.0.1:8001/api/training/employee_trainings/");
        // const training = trainingRes.data;
        
        // 10. Fetch overtime data
        const overtimeResponse = await axios.get("http://127.0.0.1:8001/api/overtime_requests/");
        setOvertimeRequestsData(overtimeResponse.data);
        
        // 11. Fetch positions data
        const positionsRes = await axios.get("http://127.0.0.1:8001/api/positions/positions/");
        ...
        const interviewsRes = await axios.get("http://127.0.0.1:8001/api/interviews/");
        ...
        const onboardingTasksRes = await axios.get("http://127.0.0.1:8001/api/onboarding/");
