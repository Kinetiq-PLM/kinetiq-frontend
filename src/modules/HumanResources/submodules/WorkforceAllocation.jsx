...
const WorkforceAllocation = () => {
  ...
  const fetchAllocations = async () => {
    ...
    try {
      const [activeRes, archivedRes] = await Promise.all([
        axios.get("http://127.0.0.1:8001/api/workforce_allocation/workforce_allocations/"),
        axios.get("http://127.0.0.1:8001/api/workforce_allocation/workforce_allocations/archived/")
      ]);
  ...
  const handleArchive = async (id) => {
    try {
      ...
      await axios.post(`http://127.0.0.1:8001/api/workforce_allocation/workforce_allocations/${id}/archive/`);
  ...
  const handleUnarchive = async (id) => {
    try {
      await axios.post(
        `http://127.0.0.1:8001/api/workforce_allocation/workforce_allocations/${id}/unarchive/`,
        {}, // Empty payload
        {
          headers: {
...
const handleAddAllocation = async (e) => {
  ...
  try {
    ...
    const response = await axios.post(
      "http://127.0.0.1:8001/api/workforce_allocation/workforce_allocations/", 
      payload,
      {
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleEditAllocation = async (e) => {
    ...
    try {
      ...
      await axios.patch(
        `http://127.0.0.1:8001/api/workforce_allocation/workforce_allocations/${editingAllocation.allocation_id}/`, 
        {
  ...
  const updateEmployeeStatus = async (employeeId, status) => {
    try {
      ...
      const response = await axios.patch(
        `http://127.0.0.1:8001/api/employees/${employeeId}/`,
        { status: status },
        {
          headers: {
            'Content-Type': 'application/json',
