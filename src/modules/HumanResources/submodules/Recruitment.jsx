...
useEffect(() => {
    ...
    try {
      ...
      try {
        const [candidatesRes, archivedCandidatesRes] = await Promise.all([
          axios.get("http://127.0.0.1:8001/api/candidates/candidates/"),
          axios.get("http://127.0.0.1:8001/api/candidates/candidates/archived/")
        ]);
      ...
      try {
        const [jobPostingsRes, archivedJobPostingsRes] = await Promise.all([
          axios.get("http://127.0.0.1:8001/api/job_posting/job_postings/"),
          axios.get("http://127.0.0.1:8001/api/job_posting/job_postings/archived/")
        ]);
      ...
      try {
        const [activeInterviewsRes, archivedInterviewsRes] = await Promise.all([
          axios.get("http://127.0.0.1:8001/api/interviews/?is_archived=false"),
          axios.get("http://127.0.0.1:8001/api/interviews/?is_archived=true")
        ]);
      ...
      try {
        const [onboardingRes, archivedOnboardingRes] = await Promise.all([
          axios.get("http://127.0.0.1:8001/api/onboarding/"),
          axios.get("http://127.0.0.1:8001/api/onboarding/?is_archived=true")
        ]);
  ...
  const handleArchiveCandidate = async (candidate) => {
    try {
      await axios.post(`http://127.0.0.1:8001/api/candidates/candidates/${candidate.candidate_id || candidate.id}/archive/`);
  ...
  const handleRestoreCandidate = async (candidate) => {
    try {
      await axios.post(`http://127.0.0.1:8001/api/candidates/candidates/${candidate.candidate_id || candidate.id}/restore/`);
  ...
  const handleEditCandidateSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `http://127.0.0.1:8001/api/candidates/candidates/${editingCandidate.candidate_id || editingCandidate.id}/`,
        formData,
        {
          headers: {
      ...
      const candidatesRes = await axios.get("http://127.0.0.1:8001/api/candidates/candidates/");
  ...
  const bulkUnarchiveCandidates = async () => {
    try {
      ...
      const promises = selectedArchivedCandidates.map(id => 
        axios.post(`http://127.0.0.1:8001/api/candidates/candidates/${id}/restore/`)
      );
  ...
  const bulkUnarchiveJobPostings = async () => {
    try {
      ...
      const promises = selectedArchivedJobPostings.map(id => {
        ...
        // Send update request
        return axios.patch(
          `http://127.0.0.1:8001/api/job_posting/job_postings/${id}/`, 
          updateData
        );
      });
...
const handleArchiveInterview = async (interview) => {
  try {
    await axios.post(`http://127.0.0.1:8001/api/interviews/${interview.interview_id}/archive/`);
...
const handleRestoreInterview = async (interview) => {
  try {
    await axios.post(`http://127.0.0.1:8001/api/interviews/${interview.interview_id}/unarchive/`);
...
const handleEditInterviewSubmit = async (e) => {
  ...
  try {
    ...
    // Submit to API
    const response = await axios.patch(
      `http://127.0.0.1:8001/api/interviews/${editingInterview.interview_id}/`,
      apiData
    );
...
const bulkUnarchiveInterviews = async () => {
  try {
    ...
    const promises = selectedArchivedInterviews.map(id => 
      axios.post(`http://127.0.0.1:8001/api/interviews/${id}/unarchive/`)
    );
...
const handleEditJobPostingSubmit = async (e) => {
  ...
  try {
    ...
    await axios.patch(
      `http://127.0.0.1:8001/api/job_posting/job_postings/${editingJobPosting.job_id}/`, 
      jobPostingData
    );
    ...
    const jobPostingsRes = await axios.get("http://127.0.0.1:8001/api/job_posting/job_postings/");
    setJobPostings(jobPostingsRes.data);
  } catch (err) {
...
const handleJobPostingSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.post("http://127.0.0.1:8001/api/job_posting/job_postings/", jobPostingData);
...
const handleArchiveJobPosting = async (jobPosting) => {
  try {
    ...
    await axios.patch(
      `http://127.0.0.1:8001/api/job_posting/job_postings/${jobPosting.job_id}/`, 
      updateData
    );
...
const submitCandidateForm = async (e) => {
  ...
  try {
    ...
    const response = await axios.post(
      "http://127.0.0.1:8001/api/candidates/candidates/",
      formData,
      {
        headers: {
          'Content-Type': 'multipart/form-data',
  ...
  const handleUploadSubmit = async (e) => {
    ...
    try {
      ...
      const candidateResponse = await axios.get(`http://127.0.0.1:8001/api/candidates/candidates/${currentCandidate.candidate_id || currentCandidate.id}/`);
      ...
      await axios.patch(
        `http://127.0.0.1:8001/api/candidates/candidates/${currentCandidate.candidate_id || currentCandidate.id}/`, 
...
const handleOnboardingTaskSubmit = async (e) => {
  ...
  try {
    ...
    const onboardingRes = await axios.get("http://127.0.0.1:8001/api/onboarding/");
    setOnboardingTasks(ensureArray(onboardingRes.data));
...
const handleEditOnboardingTaskSubmit = async (e) => {
  ...
  try {
    ...
    // Submit to API
    const response = await axios.patch(
      `http://127.0.0.1:8001/api/onboarding/${editingOnboardingTask.onboarding_id}/`,
      onboardingData
    );
...
const handleArchiveOnboardingTask = async (task) => {
  try {
    await axios.post(`http://127.0.0.1:8001/api/onboarding/${task.onboarding_id}/archive/`);
    ...
    try {
      const archivedOnboardingRes = await axios.get("http://127.0.0.1:8001/api/onboarding/?is_archived=true");
      setArchivedOnboardingTasks(ensureArray(archivedOnboardingRes.data));
    } catch (err) {
...
const handleRestoreOnboardingTask = async (task) => {
  try {
    await axios.post(`http://127.0.0.1:8001/api/onboarding/${task.onboarding_id}/unarchive/`);
...
const bulkUnarchiveOnboardingTasks = async () => {
  try {
    ...
    const promises = selectedArchivedOnboardingTasks.map(id => 
      axios.post(`http://127.0.0.1:8001/api/onboarding/${id}/unarchive/`)
    );
