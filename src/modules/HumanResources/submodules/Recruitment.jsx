...
useEffect(() => {
    ...
    try {
      ...
      try {
        const [candidatesRes, archivedCandidatesRes] = await Promise.all([
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/"),
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/archived/")
        ]);
      ...
      try {
        const [jobPostingsRes, archivedJobPostingsRes] = await Promise.all([
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/"),
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/archived/")
        ]);
      ...
      try {
        const [activeInterviewsRes, archivedInterviewsRes] = await Promise.all([
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/interviews/?is_archived=false"),
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/interviews/?is_archived=true")
        ]);
      ...
      try {
        const [onboardingRes, archivedOnboardingRes] = await Promise.all([
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/"),
          axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/?is_archived=true")
        ]);
  ...
  const handleArchiveCandidate = async (candidate) => {
    try {
      await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/${candidate.candidate_id || candidate.id}/archive/`);
  ...
  const handleRestoreCandidate = async (candidate) => {
    try {
      await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/${candidate.candidate_id || candidate.id}/restore/`);
  ...
  const handleEditCandidateSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/${editingCandidate.candidate_id || editingCandidate.id}/`,
        formData,
        {
          headers: {
  ...
  const bulkUnarchiveCandidates = async () => {
    try {
      ...
      const promises = selectedArchivedCandidates.map(id => 
        axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/${id}/restore/`)
      );
  ...
  const bulkUnarchiveJobPostings = async () => {
    try {
      ...
      const promises = selectedArchivedJobPostings.map(id => {
        ...
        // Send update request
        return axios.patch(
          `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/${id}/`, 
          updateData
        );
      });
...
const handleArchiveInterview = async (interview) => {
  try {
    await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/interviews/${interview.interview_id}/archive/`);
...
const handleRestoreInterview = async (interview) => {
  try {
    await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/interviews/${interview.interview_id}/unarchive/`);
...
const handleEditInterviewSubmit = async (e) => {
  ...
  try {
    ...
    // Submit to API
    const response = await axios.patch(
      `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/interviews/${editingInterview.interview_id}/`,
      apiData
    );
...
const bulkUnarchiveInterviews = async () => {
  try {
    ...
    const promises = selectedArchivedInterviews.map(id => 
      axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/interviews/${id}/unarchive/`)
    );
...
const handleEditJobPostingSubmit = async (e) => {
  ...
  try {
    ...
    await axios.patch(
      `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/${editingJobPosting.job_id}/`, 
      jobPostingData
    );
...
const handleJobPostingSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.post("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/", jobPostingData);
...
const handleArchiveJobPosting = async (jobPosting) => {
  try {
    ...
    await axios.patch(
      `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/${jobPosting.job_id}/`, 
      updateData
    );
...
const submitCandidateForm = async (e) => {
  ...
  try {
    ...
    const response = await axios.post(
      "https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/",
      formData,
      {
        headers: {
          'Content-Type': 'multipart/form-data',
  ...
  const handleUploadSubmit = async (e) => {
    ...
    try {
      ...
      const candidateResponse = await axios.get(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/${currentCandidate.candidate_id || currentCandidate.id}/`);
      ...
      await axios.patch(
        `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/candidates/candidates/${currentCandidate.candidate_id || currentCandidate.id}/`, 
...
const handleOnboardingTaskSubmit = async (e) => {
  ...
  try {
    ...
    const onboardingRes = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/");
    setOnboardingTasks(ensureArray(onboardingRes.data));
...
const handleEditOnboardingTaskSubmit = async (e) => {
  ...
  try {
    ...
    // Submit to API
    const response = await axios.patch(
      `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/${editingOnboardingTask.onboarding_id}/`,
      onboardingData
    );
...
const handleArchiveOnboardingTask = async (task) => {
  try {
    await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/${task.onboarding_id}/archive/`);
    ...
    try {
      const archivedOnboardingRes = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/?is_archived=true");
      setArchivedOnboardingTasks(ensureArray(archivedOnboardingRes.data));
    } catch (err) {
...
const handleRestoreOnboardingTask = async (task) => {
  try {
    await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/${task.onboarding_id}/unarchive/`);
...
const bulkUnarchiveOnboardingTasks = async () => {
  try {
    ...
    const promises = selectedArchivedOnboardingTasks.map(id => 
      axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/onboarding/${id}/unarchive/`)
    );
