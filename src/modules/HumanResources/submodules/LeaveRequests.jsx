...
const LeaveRequests = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const leaveResponse = await axios.get("http://127.0.0.1:8001/api/employee_leave_requests/leave_requests/");
      ...
      const archivedResponse = await axios.get("http://127.0.0.1:8001/api/employee_leave_requests/leave_requests/archived/");
      setArchivedLeaveRequests(archivedResponse.data);
  
      // Fetch leave balances
      const balancesResponse = await axios.get("http://127.0.0.1:8001/api/employee_leave_balances/employee_leave_balances/");
  ...
  const fetchEmployees = async () => {
    try {
      const res = await axios.get("http://127.0.0.1:8001/api/employees/");
  ...
  const handleArchiveLeaveRequest = async (leaveId) => {
    ...
    try {
      await axios.post(`http://127.0.0.1:8001/api/employee_leave_requests/leave_requests/${leaveId}/archive/`);
  ...
  const handleUnarchiveLeaveRequest = async (leaveId) => {
    ...
    try {
      await axios.post(`http://127.0.0.1:8001/api/employee_leave_requests/leave_requests/${leaveId}/unarchive/`);
...
const handleEditLeaveRequest = async (e) => {
  ...
  try {
    ...
    await axios.patch(
      `http://127.0.0.1:8001/api/employee_leave_requests/leave_requests/${editingRequest.leave_id}/`,
      requestData
    );
