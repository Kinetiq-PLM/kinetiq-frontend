...
const LeaveRequests = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const leaveResponse = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/employee_leave_requests/leave_requests/");
      ...
      const archivedResponse = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/employee_leave_requests/leave_requests/archived/");
      setArchivedLeaveRequests(archivedResponse.data);
  
      // Fetch leave balances
      const balancesResponse = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/employee_leave_balances/employee_leave_balances/");
  ...
  const fetchEmployees = async () => {
    try {
      const res = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/employees/");
  ...
  const handleArchiveLeaveRequest = async (leaveId) => {
    ...
    try {
      await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/employee_leave_requests/leave_requests/${leaveId}/archive/`);
  ...
  const handleUnarchiveLeaveRequest = async (leaveId) => {
    ...
    try {
      await axios.post(`https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/employee_leave_requests/leave_requests/${leaveId}/unarchive/`);
...
const handleEditLeaveRequest = async (e) => {
  ...
  try {
    ...
    await axios.patch(
      `https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/employee_leave_requests/leave_requests/${editingRequest.leave_id}/`,
      requestData
    );
