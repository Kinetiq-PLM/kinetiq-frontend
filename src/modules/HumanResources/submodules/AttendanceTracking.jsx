...
const AttendanceTracking = () => {
  ...
  const fetchAttendance = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/attendance_tracking/attendance_tracking/");
  ...
  const fetchCalendarDates = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/calendar_dates/calendar_dates/");
      // Ensure we're setting an array, even if the response is unexpected
      const responseData = Array.isArray(res.data) ? res.data : [];
...
const fetchOvertimeRequests = async () => {
  ...
  try {
    ...
    const res = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/overtime_requests/");
    const responseData = Array.isArray(res.data) ? res.data : [];
