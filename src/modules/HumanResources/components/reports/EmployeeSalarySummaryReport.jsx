...
useEffect(() => {
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get("http://127.0.0.1:8000///api/employee_salary/employee_salary/");
      ...
      for (const employeeId of employeeIds) {
        try {
          const empRes = await axios.get(`http://127.0.0.1:8000///api/employees/employees/${employeeId}/`);
