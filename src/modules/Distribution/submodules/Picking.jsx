...
const handleStatusUpdate = async (list, newStatus, employeeId) => {
  try {
    ...
    // Make the API call
    const response = await fetch(`http://r7d8au0l77.execute-api.ap-southeast-1.amazonaws.com/dev/api/picking-lists/${list.picking_list_id}/update/`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
...
const handleConfirmCompletion = async () => {
  ...
  try {
    const response = await fetch(`http://r7d8au0l77.execute-api.ap-southeast-1.amazonaws.com/dev/api/picking-lists/${selectedList.picking_list_id}/update/`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
