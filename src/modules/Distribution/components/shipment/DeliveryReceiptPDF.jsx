    ...
    const fetchData = async () => {
      try {
        const [carriersResponse, employeesResponse] = await Promise.all([
          fetch('https://r7d8au0l77.execute-api.ap-southeast-1.amazonaws.com/dev/api/carriers/'),
          fetch('https://r7d8au0l77.execute-api.ap-southeast-1.amazonaws.com/dev/api/carrier-employees/')
        ]);
