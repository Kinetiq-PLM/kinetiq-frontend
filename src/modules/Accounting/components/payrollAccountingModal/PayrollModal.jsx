...
const PayrollModal = ({ isModalOpen, closeModal, reportForm, handleInputChange, handleSubmit, setValidation, }) => {
        ...
        <div className="modal-container">
          ...
          <div className="modal-body mt-4">
            ...
            <div className="flex flex-col gap-y-1">
              <label>Payroll Accounting ID*</label>
              <Dropdown
                style="selection"
