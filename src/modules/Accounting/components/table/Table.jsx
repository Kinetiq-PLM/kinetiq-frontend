...
const Table = ({ columns, data, enableCheckbox, handleStatusToggle, handlePrintRow }) => {
            ...
            {row.map((cell, cellIndex) => {
                ...
                return (
                    <td key={cellIndex} className={isStatusColumn ? "status-cell" : ""}>
                        <div
                            className={isStatusColumn
                                ? cell === "Active" ? "status-active"
                                : cell === "Inactive" ? "status-inactive"
                                : cell === "Draft" ? "status-draft"
                                : cell === "Processing" ? "status-processing"
