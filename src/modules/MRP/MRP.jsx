            ...
            <div className='body-content-container'>
                ...
                <div className="mrp-table-scroll">
                    <div className="card-container">
                        ...
                        <div onClick={() => {setActiveSubModule("Principal Items");loadSubModule("Principal Items");}} className="card bills">
                            <img className="MRPIcon7" src="/icons/module-icons/MRP-icons/MRPIcon7.png" alt="Principal Items" />
                            <div className="card-text">PRINCIPAL ITEMS</div>
                        </div>
