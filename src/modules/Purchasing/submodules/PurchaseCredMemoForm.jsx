...
const PurchaseCredMemoForm = ({ memoData, onClose }) => {
    ...
    const fetchCreditMemoData = async (credit_memo_id) => {
        try {
            ...
            const creditMemoResponse = await axios.get("http://127.0.0.1:8000/api/credit-memo/list/");
            ...
            const invoiceResponse = await axios.get("http://127.0.0.1:8000/api/invoices/list/");
