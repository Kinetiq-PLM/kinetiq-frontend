...
const AddItemModal = ({ isOpen, onClose, onAdd, onViewInventory }) => {
      ...
      <div className="modal-container edit-item-modal">
        ...
        <div className="inventory-request-section">
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            <button className="view-inventory-button" onClick={onViewInventory} style={{ backgroundColor: "#00a8a8" }}>
              View Inventory
            </button>
            <button className="purchase-request-button" style={{ backgroundColor: "#00a8a8" }}>
              Purchase Request
            </button>
          </div>
        </div>
