  ...
  const handleAddPosting = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/", 
        jobPostingData
      );
      ...
      // Refresh data
      const postingsRes = await axios.get("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/job_posting/job_postings/");
      setPostings(postingsRes.data);
