...
const InvRestockForm = ({ onClose, selectedItem, activeTab }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requestResponse = await fetch("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/purchase-requests/", {
        method: "POST",
      ...
      const quotationContentResponse = await fetch("https://1wj5891jxg.execute-api.ap-southeast-1.amazonaws.com/dev/api/quotation-contents/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
