...
const InvTransferStockForm = ({ onClose, selectedItem, warehouseList }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const warehouseMovementResponse = await fetch("https://65umlgnumg.execute-api.ap-southeast-1.amazonaws.com/dev/api/warehousemovement-transfer/", {
        method: "POST",
      ...
      const warehouseMovementItemResponse = await fetch("https://65umlgnumg.execute-api.ap-southeast-1.amazonaws.com/dev/api/warehousemovement-items/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
